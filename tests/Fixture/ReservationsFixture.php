...
class ReservationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'reservations_ibfk_1' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reservations_ibfk_2' => ['type' => 'foreign', 'columns' => ['destiny_id'], 'references' => ['destinies', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reservations_ibfk_4' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
